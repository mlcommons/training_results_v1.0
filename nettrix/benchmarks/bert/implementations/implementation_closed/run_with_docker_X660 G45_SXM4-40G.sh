...
#readonly docker_image=${CONT:-"nvcr.io/nvdlfwea/mlperfv1/bert:20210517.pytorch"}
# Location of dataset for phase 1
#readonly DATADIR="/SET_THIS_TO_LOCAL_DATASET_DIR/mlperf/dataset/hdf5/2048_shards"
#readonly DATADIR="/mlperf-datasets/bert/ck_pt"
...
BERT_CMD="\
    ...
    --log_freq=0 \
    --distributed_lamb   --unpad --unpad_fmha --exchange_padding \
