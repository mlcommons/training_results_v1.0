...
_cont_mounts=("--volume=${DATADIR}:/workspace/data" "--volume=$(pwd)/mlperf_logger.py:/workspace/bert/mlperf_logger.py" "--volume=${DATADIR_PHASE2}:/workspace/data_phase2" "--volume=${CHECKPOINTDIR}:/results" "--volume=${CHECKPOINTDIR_PHASE1}:/workspace/phase1" "--volume=${EVALDIR}:/workspace/evaldata")
