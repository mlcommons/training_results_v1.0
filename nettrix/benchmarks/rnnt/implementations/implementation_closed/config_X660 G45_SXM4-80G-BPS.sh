...
#export DATADIR="/mnt/rnnt"
export DATADIR="/pmem1/rnnt"
#export METADATA_DIR="/lustre/fsw/mlperf-ci/tokenized/"
#export METADATA_DIR="/mnt/rnnt/metadata"
export METADATA_DIR="/pmem1/rnnt/metadata"
#export SENTENCEPIECES_DIR="/lustre/fsw/mlperf-ci/sentpiece"
#export SENTENCEPIECES_DIR="/mnt/rnnt/sentencepieces"
export SENTENCEPIECES_DIR="/pmem1/rnnt/sentencepieces"
