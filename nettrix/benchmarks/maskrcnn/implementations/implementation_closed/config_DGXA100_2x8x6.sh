## DL params
: "${ENABLE_DALI:=False}" # TODO: enable DALI input pipeline by default
: "${USE_CUDA_GRAPH:=True}"
...
export EXTRA_PARAMS=""
export EXTRA_CONFIG='SOLVER.BASE_LR 0.12 SOLVER.WARMUP_FACTOR 0.000192 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (12000,16000) SOLVER.IMS_PER_BATCH 96 TEST.IMS_PER_BATCH 256 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 6000 NHWC True'
