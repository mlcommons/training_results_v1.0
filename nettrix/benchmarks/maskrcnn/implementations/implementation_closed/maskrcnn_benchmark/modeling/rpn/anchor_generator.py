...
class AnchorGenerator(nn.Module):
    ...
    def forward_single_image(self, image_sizes, feature_map, cell_anchors, stride):
        ...
        if not feature_map.is_cuda:
            ...
            anchors, inds_inside = C.anchor_generator(image_height, image_width, (grid_height, grid_width), cell_anchors, stride, self.straddle_thresh)

        anchors = BoxList(anchors, (800, 1344), mode="xyxy")
