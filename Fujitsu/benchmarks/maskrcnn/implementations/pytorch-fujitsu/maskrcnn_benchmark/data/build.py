...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, random_number_generator=None, seed=41, shapes=None):
    ...
    aspect_grouping = [1] if is_train and cfg.DATALOADER.ASPECT_RATIO_GROUPING else []
    ...
    for dataset in datasets:
        ...
        if is_hybrid_loader:
            collator = BatchCollator(cfg.DATALOADER.SIZE_DIVISIBILITY, None, True)
            data_loader = HybridDataLoader3(cfg, is_train, images_per_gpu, batch_sampler, dataset, collator, transforms, cfg.DATALOADER.SIZE_DIVISIBILITY, shapes)
