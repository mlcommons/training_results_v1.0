...
class RPNModule(torch.nn.Module):
    ...
    def __init__(self, cfg):
        ...
        anchor_generator, head = build_rpn_head(cfg)
        ...
        self.head = None if cfg.MODEL.BACKBONE.INCLUDE_RPN_HEAD else head
        self.box_selector_train = box_selector_train
        self.box_selector_test = box_selector_test
        self.loss_evaluator = loss_evaluator
        self.nhwc = cfg.NHWC

    def forward(self, images, features, targets=None, objectness=None, rpn_box_regression=None):
        """
        Arguments:
