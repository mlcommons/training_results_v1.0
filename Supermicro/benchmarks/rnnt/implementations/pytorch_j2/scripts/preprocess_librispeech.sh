...
python /workspace/rnnt/scripts/utils/convert_librispeech.py \
...
bash scripts/scripts/create_sentencepieces.sh
python scripts/scripts/tokenize_transcripts.py --model /datasets/sentencepieces/librispeech1023.model /datasets/LibriSpeech/librispeech-*.json
