...
# "${CMD[@]}" test_mgpu.py
# --train_manifests ${DATASET_DIR}/librispeech-train-clean-100-wav.json ${DATASET_DIR}/librispeech-train-clean-360-wav.json ${DATASET_DIR}/librispeech-train-other-500-wav.json; \
