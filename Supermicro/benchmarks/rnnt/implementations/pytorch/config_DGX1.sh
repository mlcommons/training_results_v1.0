...
export METADATA_DIR="/fs/sjc1-lcl01/ent/mlperf/bmark/rnnt/mwawrzos/datasets/tokenized/"
export SENTENCEPIECES_DIR="/fs/sjc1-lcl01/ent/mlperf/bmark/rnnt/datasets/sentencepieces/"
