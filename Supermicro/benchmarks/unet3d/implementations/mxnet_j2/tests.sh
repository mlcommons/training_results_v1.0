...
echo "DALI 8 GPU spatial SL cache"
horovodrun -np 8 python main.py --amp --data_dir /data/kits19_ncdhw --epochs 2 -v --benchmark -sgs 2 --eval_every 1 --start_eval_at 0 -ucl -ibm 2 -ced
