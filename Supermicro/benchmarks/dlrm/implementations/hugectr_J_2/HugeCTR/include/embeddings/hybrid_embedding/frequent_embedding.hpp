...
class FrequentEmbedding {
 public:
  ...
  /// TODO: figure out the best way to manage this
  ...
  //  [size num_frequent]
  Tensor2<bool> network_cache_mask_;
  ...
  void update_model(float lr, cudaStream_t stream);
  ...
  typename std::enable_if<std::is_same<emtype, float>::value, Tensor2<T>>::type&
  get_gradients() {
