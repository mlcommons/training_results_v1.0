...
def main():
    ...
    cpu_ranges = []
    cpu_ranges.append([0,3,64,67])  #local_rank=0
    cpu_ranges.append([4,7,68,71])  #local_rank=1
    cpu_ranges.append([8,11,72,75])  #local_rank=2
    cpu_ranges.append([12,15,76,79])  #local_rank=3
    cpu_ranges.append([32,35,96,99]) #local_rank=4
    cpu_ranges.append([36,39,100,103]) #local_rank=5
    cpu_ranges.append([40,43,104,107])   #local_rank=6
    cpu_ranges.append([44,47,108,111])   #local_rank=7
    ...
    memnode.append(2)  #local_rank=4
    memnode.append(2)  #local_rank=5
    memnode.append(2)  #local_rank=6
    memnode.append(2)  #local_rank=7
