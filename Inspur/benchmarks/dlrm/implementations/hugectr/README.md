...
Steps required to launch DLRM training with HugeCTR on a single NF5488M6/NF5688M6/NF5488A5:
...
You will need to manually change the location of the datasets in the `nf5488m6.json` or `nf5688m6.json` or `nf5488a5.json` files.
...
```
source config_NF5488M6.sh(or config_NF5688M6.sh/config_NF5488A5.sh)
