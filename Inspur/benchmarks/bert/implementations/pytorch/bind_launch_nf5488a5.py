...
def main():
    ...
    cpu_ranges = []
    cpu_ranges.append([0,15,128,143])  #local_rank=0
    cpu_ranges.append([16,31,144,159])  #local_rank=1
    cpu_ranges.append([32,47,160,175])  #local_rank=2
    cpu_ranges.append([48,63,176,191])  #local_rank=3
    cpu_ranges.append([64,79,192,207]) #local_rank=4
    cpu_ranges.append([80,95,208,223]) #local_rank=5
    cpu_ranges.append([96,111,224,239])   #local_rank=6
    cpu_ranges.append([112,127,240,254])   #local_rank=7
    memnode = []
