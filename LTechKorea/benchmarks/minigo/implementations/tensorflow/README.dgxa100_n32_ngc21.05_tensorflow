...
```
    ...
    source config_DGXA100_multi_32nodes.sh 
    CONT="mlperf-nvidia:minigo" DATADIR=<path/to/store/checkpoint> LOGDIR=<path/to/output/dir> sbatch -N 32 -t $WALLTIME run.sub
```
