...
_cont_mounts=("--volume=${DATADIR}:/data" "--volume=${LOGDIR}:/results" "--volume=/mnt/data/coco2017/pretrained:/pretrained/mxnet")
...
#    -v ${PWD}/config_DSS8440x8A100-PCIE-40GB.sh /workspace/ssd/config_DSS8440x8A100-PCIE-40GB.sh \
# Run experiments
...
log_event(key=constants.CACHE_CLEAR, value=True)"
        ...
        # Run experiment
        docker exec -it "${_config_env[@]}" "${_cont_name}" ./run_inside_docker.sh
