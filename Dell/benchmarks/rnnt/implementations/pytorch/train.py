...
def main():
    ...
    logging.log_event(logging.constants.SUBMISSION_ORG, value='Dell')
    ...
    logging.log_event(logging.constants.SUBMISSION_PLATFORM, value=f'{num_nodes}xDSS8440x8A100-PCIE-40GB')
