...
param_name_dict = {
    ...
    'bert/embeddings/token_type_embeddings': 'bert.bert.bert_embedding_postprocessor.token_type_embedding.embedding_table',
    'bert/embeddings/position_embeddings': 'bert.bert.bert_embedding_postprocessor.full_position_embedding.embedding_table',
