...
class BertLearningRate(LearningRateSchedule):
    ...
    """
    def __init__(self, learning_rate, end_learning_rate, warmup_steps, start_warmup_steps, decay_steps, power):
    ...
    def construct(self, global_step):
        ...
        if self.warmup_flag:
            ...
            warmup_lr = self.warmup_lr(global_step - self.start_warmup_steps)
