...
def dummy_example():
  ...
  mllogger.event(key=mllog.constants.SUBMISSION_POC_NAME, value="Wei Wang, Deepak Canchi")
  mllogger.event(key=mllog.constants.SUBMISSION_POC_EMAIL, value="wei.v.wang@intel.com, deepak.r.canchi@intel.com")
