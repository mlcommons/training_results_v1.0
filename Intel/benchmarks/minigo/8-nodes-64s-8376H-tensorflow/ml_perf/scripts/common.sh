...
# setup a selfplay master dir to gather games from all nodes to node 0
# note: the last level directory name MUST match the last level
#       directory name of $selfplay_dir
selfplay_master_dir=/tmp/selfplay

#setup a per-node selfplay dir that synchronizes with selfplay master dir on node 0
selfplay_local_dir=/tmp/selfplay_local/
