...
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn.object_detection import argmax_matcher
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn.object_detection import balanced_positive_negative_sampler
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn.object_detection import box_list
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn.object_detection import faster_rcnn_box_coder
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn.object_detection import region_similarity_calculator
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn.object_detection import target_assigner
  ...
  def unpack_labels(self, labels):
    ...
    for level in range(self.min_level, self.max_level + 1):
      ...
      labels_unpacked[level] = tf.reshape(
          labels[count:count + steps], [steps, -1])
      count += steps
