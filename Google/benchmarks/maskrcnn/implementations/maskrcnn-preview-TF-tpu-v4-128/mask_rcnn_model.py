...
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn import anchors
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn import fpn
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn import losses
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn import lr_policy
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn import mask_rcnn_architecture
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn import mask_rcnn_params
from REDACTED.mlperf.submissions.training.v1_0.models.mask_rcnn import post_processing
...
class MaskRcnnModelFn(object):
  ...
  def get_optimizer(self, learning_rate):
    ...
    return tf.tpu.CrossShardOptimizer(optimizer)
  ...
  def _model_outputs(self, features, labels, image_size, is_training):
    ...
    if self.params['transpose_img_dimensions_last']:
      images = tf.reshape(features['images'], [
          -1, 3 * self.params['conv0_space_to_depth_block_size'] *
          self.params['conv0_space_to_depth_block_size'],
          image_size[0], image_size[1]])
      images = tf.transpose(images, [0, 2, 3, 1])
    elif self.params['transpose_input']:
      images = tf.reshape(features['images'], [
