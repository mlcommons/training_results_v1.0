...
PARSER.add_argument('--data_dir', dest='data_dir', type=str, default='/tmp')
...
PARSER.add_argument(
    ...
    dest='normalization',
    type=str,
    choices=['instancenorm', 'batchnorm', 'syncbatchnorm'],
...
PARSER.add_argument(
    ...
    dest='pad_mode',
    default='reflect',
    choices=['constant', 'edge', 'reflect', 'median', 'symmetric'],
    type=str)
