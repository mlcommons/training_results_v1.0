#include "REDACTEDsubmissions/training/v1_0/models/util/roc_metrics/roc_metrics.h"  //NOLINT
...
#include "third_party/boost/do_not_include_from_REDACTED_only_third_party/boost/boost/sort/block_indirect_sort/block_indirect_sort.hpp"  //NOLINT
...
void ParallelSort(absl::Span<T> elements, const Compare& comp) {
  ...
  // REDACTED.  If using this library in a non-third_party project, this will
  // need to be replaced.
