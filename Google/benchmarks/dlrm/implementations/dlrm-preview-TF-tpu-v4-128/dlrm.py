...
from REDACTED.tensorflow.compiler.tf2xla.python import xla
from REDACTED.tensorflow.contrib import layers as contrib_layers
...
def logits_fn(features, params, feature_config):
  ...
  num_features = int(feature_stack.shape[1])
  ...
  orig_top_mlp_dim = (
      num_features * (num_features - 1)) // 2 + params["dim_embed"]
...
# TODO: Clean this up and merge with estimator invocation.
def dlrm_llr_model_fn(params,
  ...
  if is_training:
    ...
    # TODO: Consider adding a local key-value sort.
