...
from REDACTED.mlperf.submissions.training.v1_0.models.ssd import ssd_architecture
...
def _localization_loss(pred_locs, gt_locs, gt_labels, num_matched_boxes):
  ...
  # TODO: Confirm that normalizing by the number of boxes matches
  # reference
...
def ssd_model_fn(params, features, labels, is_training):
  ...
  optimizer = WeightDecayOptimizer(optimizer, params['weight_decay'])
