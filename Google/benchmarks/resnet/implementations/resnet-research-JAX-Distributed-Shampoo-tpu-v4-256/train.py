...
from REDACTED.mlperf.submissions.training.v1_0.models.resnet_jax import mllog
from REDACTED.mlperf.submissions.training.v1_0.models.resnet_jax import mlperf_input_pipeline as input_pipeline
from REDACTED.mlperf.submissions.training.v1_0.models.resnet_jax import models
from REDACTED.mlperf.submissions.training.v1_0.models.resnet_jax import shampoo
...
def main(argv):
  ...
  mllogger.start('block_start',
                 metadata={'first_epoch_num': 1,
                           'epoch_count': FLAGS.epochs_per_loop})
  for loop in range(int(math.ceil((num_epochs + 4) / FLAGS.epochs_per_loop))):
    # BEGIN GOOGLE-INTERNAL
