...
def input(conf_yaml, split='train'):
    ...
    conf_padalign = validate_and_fill(features.PadAlign, conf_padalign, optional=amp)
    ...
    return conf_dataset, conf_features, conf_splicing, conf_padalign, conf_specaugm
